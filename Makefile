...
#----------------------------------------------------------------------
PANTECH_ANDROID_FLAGS := -DT_VEGAPVW -I$(srctree)/include/pantech \
					-include $(srctree)/include/pantech/CUST_PANTECH.h \
					-DFIRM_VER=\"S930LVWD621F.1C\" \
					-DSYS_MODEL_NAME=\"VEGAPVW\" \
					-DPANTECH_MODEL_NAME=\"ADR930L\" \
					-DSYS_PROJECT_NAME=\"PREMIA_V\"
					-DFS_USER_DATA_VER=20 \
