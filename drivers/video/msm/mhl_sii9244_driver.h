...
///#define MHL_DEBUG // 20111205, kkcho, for debug_message : 2013-Feb-13 Remove Debug message.
...
*/
		...
		(BOARD_VER>=PT10 && defined(CONFIG_MACH_MSM8960_SIRIUSLTE)) || defined(CONFIG_MACH_MSM8960_MAGNUS)
#define MHL_INT 15
#else
#define MHL_INT 92
#endif
#if (BOARD_VER>=TP10 && (defined(CONFIG_MACH_MSM8960_VEGAPVW)))
#define CONFIG_PANTECH_MHL_INT_PUSH_PULL
#endif
...
#define	T_SRC_RSEN_DEGLITCH			(250)	// Do. change 100->150 (150)

// Wait this much after connection before reacting to RSEN (300-500ms)
// Per specs between 300 to 500 ms
#define	T_SRC_RXSENSE_CHK			(500)  // Do. change 200->400 kkcho_1212, change 1119	  300->200	
#define	T_SRC_CMD_SEND_CHK			(500)  // Do. change 200->400 kkcho_1212, change 1119	  300->200	
#define	T_SRC_UVIRQ_CHK			(500)  // Do. change 200->400 kkcho_1212, change 1119	  300->200	
typedef enum
{
