...
#define RESUME_DOWNLOAD				0
#define TOUCH_ITO_CHECK				1
#define REAL_XDATA						0
#define PROTECT_IRQ_PROBLEM			0

#define MAXIM_FILE_CREATE				1
#define MAXIM_FILE_CREATE_WRITABLE	0

#define MAX11871_BOARD_CONFIG  0
