...
/* -------------------------------------------------------------------- */
#if defined(CY_AUTO_LOAD_DDATA) || defined(CY_AUTO_LOAD_MDATA) || defined(CY_USE_TOUCH_MONITOR) || defined(CONFIG_TOUCHSCREEN_DEBUG)
static int _cyttsp4_get_ebid_data_tma400(struct cyttsp4 *ts, enum cyttsp4_ic_ebid ebid, size_t row_id, u8 *pdata);
#endif /* --CY_AUTO_LOAD_DDATA || CY_AUTO_LOAD_MDATA || CY_USE_TOUCH_MONITOR || CONFIG_TOUCHSCREEN_DEBUG */
...
#endif /* --CY_AUTO_LOAD_TOUCH_PARAMS || (CONFIG_TOUCH_SCREEN_DEBUG && CY_USE_TMA400) */
