...
/* -------------------------------------------------------------------------*/
#define X_SENSOR_NUM                12
#define Y_SENSOR_NUM                20
//++ p11309
#define SELF_TEST_RAW_MIN			-70
#define SELF_TEST_RAW_MAX			30
//-- p11309
...
//++ p11309
#define CYTTSP4_USE_TOUCH_ID
#ifdef CYTTSP4_USE_TOUCH_ID
	#define CYTTSP4_TOUCH_MPP_ID	9
#endif
/* maximum number of concurrent fingers */
#define CY_MAX_FINGERNUM			5
//-- p11309
