 ...
 * 02110-1301, USA.
 * 2012.08.19 anti band test PANTECH
 */
...
static struct msm_camera_i2c_reg_conf yacd5c1sbdbc_snap_settings[] = {
	...
	{0x10, 0x95}, //11}, //Sub 1 + Preview 1 mode
	...
	{0x84, 0x0c},
	{0x85, 0x00},
	{0x90, 0x0a}, //0d}, //BLC_TIME_TH_ON
	{0x91, 0x0a}, //0d}, //BLC_TIME_TH_OFF 
	...
	{0x30, 0x05}, //For Hi-255 never no change 0x05
	{0x50, 0x20},
	{0x52, 0x01},
	...
	{0xd0, 0x0a},
	{0xd1, 0x09},
	{0xd4, 0x0a}, //0d}, //DCDC_TIME_TH_ON
	{0xd5, 0x0a}, //0d}, //DCDC_TIME_TH_OFF 
	...
	{0x47, 0x9d}, 
	{0x48, 0x1e},         
	{0x50, 0x8e}, //98},//{0x50, 0x8a}, //CMC POFS
	{0x51, 0x08}, //00},//{0x51, 0x14}, 
	{0x52, 0x06}, //18},//{0x52, 0x8a}, 
	{0x53, 0x06}, 
	{0x54, 0x07}, 
	{0x55, 0x8d}, 
	{0x56, 0x01}, 
	...
	{0x03, 0x16}, //16 Page
	{0x10, 0x31},
	{0x18, 0x81}, //a1}, //Double_AG
	{0x19, 0x80}, //a0}, //Double_AG
	{0x1a, 0x0e},
	{0x1b, 0x01},
	{0x1c, 0xdc},
	{0x1d, 0xfe},        
	{0x30, 0x00},  //00}, //Gamma indoor
	{0x31, 0x08},  //08}, //05},
	{0x32, 0x13},  //13}, //10},
	{0x33, 0x28},  //2c}, //2a},
	{0x34, 0x51},  //5b},
	...
	{0x6e, 0x00},
	{0x6f, 0x00},
	{0x70, 0x74}, //3b},//Y Target 20120827 LHC
	{0x71, 0x82}, //82(+8)
	{0x76, 0x43},
	{0x77, 0x02}, //04},
	{0x78, 0x22}, //23},
	...
	{0x8D, 0x61}, //EXP120 
	{0x8E, 0xa8}, 
	{0x9c, 0x0b}, //EXP Limit 1000.00 fps 
	{0x9d, 0xb8}, 
	{0x9e, 0x01}, //EXP Unit 
	{0x9f, 0xf4},   
	{0xb0, 0x18},
	...
	{0x80, 0x40}, //R gain
	{0x81, 0x20}, //G gain
	{0x82, 0x35}, //B gain  // 120826 ljh              
	{0x83, 0x5e}, //Indoor
	{0x84, 0x1c}, //1e}, //21}, //24}, 
	{0x85, 0x4c}, //53}, //5a}, //4a}, //50},  
	{0x86, 0x24},             
	{0x87, 0x49}, //outdoor 1  
	{0x88, 0x39},
	{0x89, 0x2f}, //{0x89, 0x37}, 
	{0x8a, 0x27}, //{0x8a, 0x29},             
	{0x8b, 0x44}, //41}, //outdoor 2
	{0x8c, 0x39}, 
	{0x8d, 0x2f}, //{0x8d, 0x32}, //34}, 
	{0x8e, 0x27}, //{0x8e, 0x2a}, //29},
	{0x8f, 0x60}, //57}, //AWB slope
	{0x90, 0x5c}, //55},
	{0x91, 0x56}, //52},
	{0x92, 0x4f}, //4d},
	{0x93, 0x48},
...
static struct msm_camera_i2c_reg_conf yacd5c1sbdbc_cfg_preview_fps_60HZ[][YACD5C1SBDBC_PREVIEW_FPS_60HZ_PARM] = {
    {//Fixed 5 fps
        {0x03, 0x20},
    ...
    {//Variable fps//Fixed 31 fps
		...
		{0x8a, 0xe0},                                                                           
		{0x03, 0x00}, //PAGE 0                                         
		{0x90, 0x0c}, //10}, //BLC_TIME_TH_ON
		{0x91, 0x0c}, //10}, //BLC_TIME_TH_OFF 
		{0x92, 0xd8}, //BLC_AG_TH_ON
		{0x93, 0xd0}, //BLC_AG_TH_OFF                               
		{0x03, 0x02}, //PAGE 2                                         
		{0xd4, 0x0c}, //10}, //DCDC_TIME_TH_ON
		{0xd5, 0x0c}, //10}, //DCDC_TIME_TH_OFF 
		{0xd6, 0xd8}, //DCDC_AG_TH_ON
		{0xd7, 0xd0}, //DCDC_AG_TH_OFF                                                                                            
		{0x03, 0x00},                                                  
		{0x03, 0x00},                                                  
		...
		{0x03, 0x00}, //0530_dummy_add
		{0x03, 0x00}, //0530_dummy_add
		{0x03, 0x00}, //0826_dummy_add
		{0x03, 0x00}, //0826_dummy_add
		{0x03, 0x00}, //0826_dummy_add
		{0x03, 0x00}, //0826_dummy_add
		{0x03, 0x00}, //0912_dummy_add
    }
}; 
...
static struct msm_camera_i2c_reg_conf yacd5c1sbdbc_cfg_antibanding[][YACD5C1SBDBC_ANTIBANDING_PARM] = {
	{	// if antibanding command iis off, antibanding set auto
		{0x03, 0x20}, // page 20 //
		{0x18, 0x38}, //AE reset on 
		{0x03, 0x17}, //Page 17 
		{0xC4, 0x3c}, //FLK200 
		...
		{0x89, 0x93}, 
		{0x8a, 0xe0},
		{0x03, 0x00}, //PAGE 0 //BLC 
		{0x90, 0x0d}, //BLC_TIME_TH_ON
		{0x91, 0x0d}, //BLC_TIME_TH_OFF 
		{0x92, 0xd8}, //BLC_AG_TH_ON
		{0x93, 0xd0}, //BLC_AG_TH_OFF
		{0x03, 0x02}, //PAGE 2 //DCDC 
    ...
    {	// 60hz
		...
		{0x18, 0x38}, //AE reset on 
		{0x03, 0x20},
		{0x83, 0x03}, //02}, //EXP Normal 15.00 fps 
		{0x84, 0x0d}, //49}, 
		{0x85, 0x40}, //f0}, 
		{0x88, 0x04}, //EXP Max 10.00 fps 
		{0x89, 0x93}, 
