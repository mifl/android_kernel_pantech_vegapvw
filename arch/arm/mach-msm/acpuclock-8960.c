...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
    { 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   925000, AVS(0x40007F) },
    ...
    { 1, {   810000, HFPLL, 1, 0x1E }, L2(6),  1050000 },
    { 0, {   864000, HFPLL, 1, 0x20 }, L2(6),  1100000 },
    { 1, {   918000, HFPLL, 1, 0x22 }, L2(6),  1100000 },
    ...
    /* EBI_ERROR patch (CN#1107209) - L2 cache corruption occured on high frequency */
    /* Below L2(18) -> L2(15) */
    { 0, {  1080000, HFPLL, 1, 0x28 }, L2(15), 1150000, AVS(0x400015) },
    { 1, {  1134000, HFPLL, 1, 0x2A }, L2(15), 1150000, AVS(0x400015) },
    { 0, {  1188000, HFPLL, 1, 0x2C }, L2(15), 1157000, AVS(0x400015) },
    { 1, {  1242000, HFPLL, 1, 0x2E }, L2(15), 1175000, AVS(0x400015) },
    { 0, {  1296000, HFPLL, 1, 0x30 }, L2(15), 1200000, AVS(0x400015) },
    { 1, {  1350000, HFPLL, 1, 0x32 }, L2(15), 1200000, AVS(0x400015) },
    { 0, {  1404000, HFPLL, 1, 0x34 }, L2(15), 1212500, AVS(0x400015) },
    { 1, {  1458000, HFPLL, 1, 0x36 }, L2(15), 1212500, AVS(0x100018) },
    { 1, {  1512000, HFPLL, 1, 0x38 }, L2(15), 1225000, AVS(0x400012) },
    { 0, { 0 } }
};
#else
/* TP3_N : Nominal Default */
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
...
/* TP2_S : Slow + 50mV */
static struct acpu_level acpu_freq_tbl_pdn_slow[] __initdata = {
    ...
    /* EBI_ERROR patch (CN#1107209) - L2 cache corruption occured on high frequency */
    /* Below L2(18) -> L2(15) */
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(15), 1225000, AVS(0x400015) },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(15), 1225000, AVS(0x400015) },
	{ 0, {  1188000, HFPLL, 1, 0x2C }, L2(15), 1250000, AVS(0x400015) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(15), 1250000, AVS(0x400015) },
	{ 0, {  1296000, HFPLL, 1, 0x30 }, L2(15), 1275000, AVS(0x400015) },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(15), 1275000, AVS(0x400015) },
	{ 0, {  1404000, HFPLL, 1, 0x34 }, L2(15), 1287500, AVS(0x400015) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(15), 1287500, AVS(0x100018) },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(15), 1300000, AVS(0x400012) },
	{ 0, { 0 } }
};

/* TP2_N : Nominal + 100mV */
static struct acpu_level acpu_freq_tbl_pdn_nom[] __initdata = {
    { 1, {   384000, PLL_8, 0, 0x00 }, L2(0),  1000000, AVS(0x40001F) },
    { 0, {   432000, HFPLL, 2, 0x20 }, L2(6),  1025000 },
    { 1, {   486000, HFPLL, 2, 0x24 }, L2(6),  1025000 },
    { 0, {   540000, HFPLL, 2, 0x28 }, L2(6),  1050000 },
...
/* TP2_F : Fast + 150mV */
static struct acpu_level acpu_freq_tbl_pdn_fast[] __initdata = {
    { 1, {   384000, PLL_8, 0, 0x00 }, L2(0),  1000000, AVS(0x40001F) },
    { 0, {   432000, HFPLL, 2, 0x20 }, L2(6),  1025000 },
    { 1, {   486000, HFPLL, 2, 0x24 }, L2(6),  1025000 },
    { 0, {   540000, HFPLL, 2, 0x28 }, L2(6),  1050000 },
...
[PDN_SLOW]    = { acpu_freq_tbl_pdn_slow,  sizeof(acpu_freq_tbl_slow),	0 },
[PDN_NOMINAL] = { acpu_freq_tbl_pdn_nom,   sizeof(acpu_freq_tbl_nom),	0 },
[PDN_FAST]    = { acpu_freq_tbl_pdn_fast,  sizeof(acpu_freq_tbl_fast),	0 },
};
